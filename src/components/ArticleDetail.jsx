...
const ArticleDetail = ({ articleId, onArticleClick, onBack, articles }) => {
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <button
        onClick={onBack}
        className="flex items-center gap-2 text-gray-600 hover:text-[#0f172a] mb-6 transition-colors"
      >
      ...
      <article>
        <header className="mb-8">
          <span className="inline-block px-3 py-1 bg-[#0f172a] text-white text-sm font-medium rounded mb-4">
            {article.category}
          </span>
