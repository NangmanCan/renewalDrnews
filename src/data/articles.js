...
export const bioPharmBreakingNews = [
  ...
  },
  {
    ...
    content: `유지우바이오는 오늘 비만 및 당뇨 치료용 경구 GLP-1 수용체 작동제가 임상 2상 시험에 진입했다고 발표했다.\n\n이 제품은 기존 주사제형 대비 복약 편의성을 크게 향상시켰다고 평가받고 있으며, 글로벌 시장에서 비만 치료 경구제 수요가 급증하는 추세와 맞추어 개발된다. 临상 2상 결과는 내년 상반기까지 도출될 것으로 예상된다.\n\n주가는 이 소식으로 장중 12.1% 급등하며 매수세가 집중되었다.`,
    author: "증권부 기자",
    date: "2026-02-03",
