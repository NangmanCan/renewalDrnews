  ...
  return (
    <div className="bg-white border border-gray-200 overflow-hidden">
      ...
      <div className="bg-navy px-5 py-3">
        <h2 className="font-headline text-base font-bold text-white tracking-wide flex items-center gap-2">
      ...
      <Link href={`/ceo-report/${report.id}`} className="block">
        <div className="p-5">
          ...
          {/* 제목 + 부제목 */}
          <h3 className="font-headline text-xl font-bold text-gray-900 mb-1 leading-tight hover:underline transition-colors">
            {report.title}
          </h3>
