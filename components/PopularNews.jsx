      ...
      <div className="p-4">
        {articles.map((article, index) => (
          <Link
            ...
            className="flex items-start gap-3 py-3 border-b border-gray-50 last:border-b-0 hover:bg-gray-50 transition-colors group"
          >
            {/* 순위 번호 */}
            <span className={`text-lg font-bold flex-shrink-0 w-6 text-center ${
