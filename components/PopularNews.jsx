...
const PopularNews = ({ articles }) => {
  ...
  return (
    <div className="bg-white border border-gray-200">
      <h3 className="font-headline text-sm font-bold text-gray-900 px-4 py-3 border-b-2 border-navy flex items-center gap-2">
      ...
      <div className="px-4 py-2">
        {articles.map((article, index) => (
          ...
          >
            ...
            {/* 기사 제목 */}
            <h4 className="text-xs font-medium text-gray-800 group-hover:underline transition-colors line-clamp-1 flex-1">
              {article.title}
            </h4>
          </Link>
        ))}
